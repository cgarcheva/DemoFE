(function () {
	...
	app.controller('HomeController',['$scope', '$interval', function($scope, $interval){
        ...
        $scope.$nextPrevBtnsInitState="show"; //next/previous image buttons initial state ("hide" or "show")
        ...
        $scope.$frame = $('#basic');
        $scope.$slidee = $frame.children('.content').eq(0);
        $scope.$wrap = $frame.parent();
